...
/**
 * Display for user to view and change accounts connected to the account
 * @param {*} navigation 
 * @returns 
 */
const ChangeConnectedAccounts = ({ navigation }) => {

  // Hard-coded pre-existing connected accounts
  ...
  // If account is not already connected, connect the new account and close the picker
  const addAccount = () => {
  ...
  // Disable 'Add' button if no new account selected
